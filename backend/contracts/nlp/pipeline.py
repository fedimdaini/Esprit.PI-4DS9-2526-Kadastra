...
- Titre transformé : {titre_transformed[:80]}'''
    ...
    user_message = (
        f'Génère le contrat COMPLET et DÉTAILLÉ : "{get_contract_title(contract_type, listing)}"\n\n'
        f'ANNONCE SOURCE :\n{listing_info}\n\n'
        'ENTRE LES SOUSSIGNÉS :\n'
        f'{vendeur_block}\n'
        f'{acheteur_block}\n\n'
        f'{nlp_section}\n\n'
        'STRUCTURE JURIDIQUE OBLIGATOIRE DU CONTRAT (Développe chaque article de manière exhaustive) :\n'
        'Préambule / Exposé des motifs (Déclaration d\'intention des parties)\n'
        'Article 1 — Objet du contrat et Identification des parties (NOM, CIN, adresse complète)\n'
        'Article 2 — Désignation précise du bien (adresse, superficie, dépendances, titre foncier)\n'
        'Article 3 — Prix, modalités de paiement et indemnité d\'immobilisation (chiffres ET lettres, DT)\n'
        'Article 4 — Déclarations et Obligations du vendeur/bailleur (références COC, garantie de jouissance paisible)\n'
        'Article 5 — Déclarations et Obligations de l\'acquéreur/locataire (références COC)\n'
        'Article 6 — Garanties légales (éviction, vices cachés selon Art. 641 et suivants du COC)\n'
        'Article 7 — Conditions suspensives et résolutoires (si applicable)\n'
        'Article 8 — Clause résolutoire de plein droit et Pénalités de retard\n'
        'Article 9 — Force majeure\n'
        'Article 10 — Enregistrement fiscal, frais et honoraires (recette des finances)\n'
        'Article 11 — Élection de domicile pour l\'exécution du présent acte\n'
        'Article 12 — Juridiction compétente (Tribunal de Première Instance)\n'
        'Article 13 — Signatures, date et lieu (Fait à Tunis, le ...)\n\n'
        'INSTRUCTIONS STRICTES :\n'
        '- Rédige le contrat INTÉGRAL, clause par clause.\n'
        '- Le ton doit être impersonnel, formel et hautement juridique.\n'
        '- Cite explicitement les articles pertinents du COC ou de la législation en vigueur pour appuyer les clauses.\n'
        '- Utilise le formatage Markdown (ex: **ARTICLE 1 - OBJET**) pour les titres.'
    )
